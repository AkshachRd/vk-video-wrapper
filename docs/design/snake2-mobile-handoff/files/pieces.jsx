...
function SnakeBorder({ shape, always }) {
  ...
  useEffect(() => {
    ...
    function measure() {
      ...
      const r = { width: host.offsetWidth || host.getBoundingClientRect().width, height: host.offsetHeight || host.getBoundingClientRect().height };
  ...
  return (
    <svg ref={svgRef} className="snake-svg" data-shape={shape || "pill"} data-always={always ? "1" : undefined} aria-hidden="true" preserveAspectRatio="none">
